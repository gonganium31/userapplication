...
class HistoryDesignUIScreen extends StatefulWidget {
  TripsHistoryModel? tripsHistoryModel;
  HistoryDesignUIScreen({this.tripsHistoryModel});

  @override
  State<HistoryDesignUIScreen> createState() => _HistoryDesignUIScreenState();
}

class _HistoryDesignUIScreenState extends State<HistoryDesignUIScreen> {
